...
describe('airport pickup task engine', () => {
  ...
  it('preserves a provider-planned route destination and ETA when navigation activates', () => {
    const preparing = {
      ...createInitialTask(),
      phase: 'preparing' as const,
      navigation: { routeId: 'route-airport-001', destination: '虹桥机场 T2', eta: '2026-07-22T20:25:00+08:00', status: 'planned' as const },
    }
    const started = applyEvent(preparing, { eventId: 'start', type: 'navigation.started', routeId: 'route-airport-001', timestamp: '2026-07-22T12:01:00+08:00' })

    expect(started.navigation).toEqual({
      routeId: 'route-airport-001', destination: '虹桥机场 T2', eta: '2026-07-22T20:25:00+08:00', status: 'active',
    })
  })
