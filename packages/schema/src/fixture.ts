 ...
 * shallow patch applied after the event, representing planner/tool writes that
 * are not driven by the event itself (e.g. passengers resolved from
 * family.resolve-members, navigation reroutes). `toolCalls` documents which
 * tools fire at this step for the demo console.
 */
