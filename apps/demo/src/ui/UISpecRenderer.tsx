...
function themeTokens(theme: UISpec['presentation']['theme']): CSSProperties {
  return theme === 'dark'
    ? ({
      ...
      '--route-soft': '#304b64',
      '--control': '#3a2d24',
      '--control-hover': '#4b392d',
      '--control-off': '#332820',
      '--control-selected': '#5b3a29',
      '--composer': '#2b211b',
      '--action-primary': '#d9874f',
      '--action-primary-hover': '#efad78',
      '--action-primary-ink': '#211711',
      '--focus-ring': '#efad78',
    ...
    : ({
      ...
      '--route-soft': '#dbe8f5',
      '--control': '#fffdf9',
      '--control-hover': '#f8efe7',
      '--control-off': '#f5eee8',
      '--control-selected': '#ead8cb',
      '--composer': '#fffaf2',
      '--action-primary': '#a34f36',
      '--action-primary-hover': '#843a2a',
      '--action-primary-ink': '#fffaf2',
      '--focus-ring': '#a34f36',
